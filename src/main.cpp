...
int main(int argc, char *argv[]) {
    ...
    MultiThreadCommandProcessor commandProcessor
    = MultiThreadCommandProcessor(block_size, consoleReader, fileWriter1, fileWriter2, consolWriter);
